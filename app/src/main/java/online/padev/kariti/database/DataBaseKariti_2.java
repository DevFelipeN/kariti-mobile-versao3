...
public class DataBaseKariti_2 extends SQLiteOpenHelper {
    public static final String DBNAME = "base_dados.db";
    private static final int DATABASE_VERSION = 27;
    public static Integer USER_ID;
    public static Integer ID_ESCOLA;
    public DataBaseKariti_2(Context context) {
    ...
    public Boolean cadastrarEscola(String nomeEscola, Integer status){
        ...
        try {
            ...
            contentValues.put("id_usuario", DataBaseKariti_2.USER_ID);
    ...
    public Integer cadastrarTurma(String nomeTurma){
        ...
        try {
            ...
            contentValues.put("id_escola", DataBaseKariti_2.ID_ESCOLA);
    ...
    public boolean cadastrarProva(Exam dadosExam, List<Answer_key> answerkey){
        SQLiteDatabase base_dados = null;
        try {
            base_dados = this.getWritableDatabase();
            base_dados.beginTransaction();
            ...
            ContentValues contentValues = new ContentValues();
            contentValues.put("nomeProva", dadosExam.getNameExam());
            contentValues.put("dataProva", dadosExam.getDateExam());
            contentValues.put("qtdQuestoes", dadosExam.getNumQuestions());
            contentValues.put("qtdAlternativas", dadosExam.getNumAlternatives());
            contentValues.put("id_turma", dadosExam.getClass_id());
    ...
    public Boolean upadateProva(Exam exam, Map<Integer, Integer> gabarito){
        SQLiteDatabase base_dados = null;
        SQLiteStatement stmt = null;
        Cursor cursor = null;
        try {
            base_dados = this.getWritableDatabase();
            base_dados.beginTransaction();
            cursor = base_dados.rawQuery("SELECT id_prova FROM resultadoCorrecao WHERE id_prova = ? AND id_aluno = ?", new String[]{exam.getExam_id().toString(), exam.getExam_id().toString()});
            if (cursor != null && cursor.moveToFirst()) {
                String deleta = "DELETE FROM resultadoCorrecao WHERE id_prova = ? AND id_aluno = ?";
                stmt = base_dados.compileStatement(deleta);
                stmt.bindLong(1, exam.getExam_id());
                stmt.bindLong(2, exam.getExam_id());
                stmt.executeUpdateDelete();
            }
            ...
            for (Integer questao : gabarito.keySet()){
                Integer respostaDada = gabarito.get(questao);
                ContentValues contentValues = new ContentValues();
                contentValues.put("id_prova", exam.getExam_id());
                contentValues.put("id_aluno", exam.getExam_id());
                contentValues.put("questao", questao);
                contentValues.put("respostaDada", respostaDada);
                long resultado = base_dados.insert("resultadoCorrecao", null, contentValues);
                if(resultado != -1){
    ...
    public boolean alterarDadosProva(Exam exam, List<Answer_key> answerkey, int status){
        ...
        try {
            ...
            if (status == 1) {
                ...
                stmtUpProva.bindString(1, exam.getNameExam());
                stmtUpProva.bindString(2, exam.getDateExam());
                stmtUpProva.bindLong(3, exam.getNumQuestions());
                stmtUpProva.bindLong(4, exam.getNumAlternatives());
                stmtUpProva.bindLong(5, exam.getClass_id());
                stmtUpProva.bindLong(6, exam.getExam_id());
            ...
            stmtDelGabarito.bindLong(1, exam.getExam_id());
    ...
    public Boolean verificaExisteEmailAluno(String email) {
        ...
        try {
            ...
            cursor = base_dados.rawQuery("SELECT email FROM aluno WHERE email = ? AND id_escola = ?", new String[]{email, DataBaseKariti_2.ID_ESCOLA.toString()});
    ...
    public Boolean verificaExisteEscola(String nomeEscola){
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeEscola FROM escola WHERE nomeEscola = ? AND id_usuario = ?", new String[]{nomeEscola, DataBaseKariti_2.USER_ID.toString()});
            return cursor != null && cursor.moveToFirst();
        } catch (Exception e){
    ...
    public Boolean verificaExisteProvaCadastrada(){
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT id_prova FROM prova, turma WHERE prova.id_turma = turma.id_turma AND turma.id_escola = ?", new String[]{DataBaseKariti_2.ID_ESCOLA.toString()});
            return cursor != null && cursor.moveToFirst();
        }catch (Exception e){
    ...
    public Boolean verificaExisteProvaCorrigida(){
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT id_prova FROM prova, turma WHERE prova.id_turma = turma.id_turma AND turma.id_escola = ? AND id_prova IN (SELECT id_prova FROM resultadoCorrecao)", new String[]{DataBaseKariti_2.ID_ESCOLA.toString()});
            return cursor != null && cursor.moveToFirst();
        }catch (Exception e){
    ...
    public Boolean checkExistsStudent(String nome){
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeAluno FROM aluno WHERE nomeAluno = ? AND id_escola = ?", new String[]{nome, DataBaseKariti_2.ID_ESCOLA.toString()});
            return cursor != null && cursor.moveToFirst();
        }catch (Exception e){
    ...
    public Boolean checkExistsStudent(Integer id_student){
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT id_aluno FROM aluno WHERE id_aluno = ? AND id_escola = ?", new String[]{id_student.toString(), DataBaseKariti_2.ID_ESCOLA.toString()});
            return cursor != null && cursor.moveToFirst();
        }catch (Exception e){
            Log.e("kariti","Erro ao tentar verificar existencia de aluno! "+e.getMessage());
            return null;
    ...
    public Boolean verificaExisteAlunosPorEscola(){
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT id_aluno FROM aluno WHERE id_escola = ? AND status = 1", new String[]{DataBaseKariti_2.ID_ESCOLA.toString()});
            return cursor != null && cursor.moveToFirst();
        }catch (Exception e){
            Log.e("kariti","Erro ao tentar verificar existencia de aluno! "+e.getMessage());
            return null;
    ...
    public Boolean verificaExisteTurmas(){
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT id_turma FROM turma WHERE id_escola = ?", new String[]{String.valueOf(DataBaseKariti_2.ID_ESCOLA)});
            return cursor != null && cursor.moveToFirst();
        }catch (Exception e){
    ...
    public Boolean verificaExisteTurmaPorNome(String turma){
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeTurma FROM turma WHERE nomeTurma = ? and id_escola = ?", new String[]{turma, String.valueOf(DataBaseKariti_2.ID_ESCOLA)});
            return cursor != null && cursor.moveToFirst();
        }catch (Exception e){
            Log.e("kariti","Erro ao tentar verificar existencia de turma! "+e.getMessage());
            return null;
    ...
    public String pegarNomeTurma(String id_turma){
        ...
        try {
            base_dados = this.getWritableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeTurma FROM turma WHERE id_turma = ? AND id_escola = ?", new String[]{id_turma, DataBaseKariti_2.ID_ESCOLA.toString()});
            if (cursor != null && cursor.moveToFirst()){
    ...
    public String pegaNomeAlunoPStatus(Integer id_aluno, Integer status) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeAluno FROM aluno WHERE id_aluno = ? AND id_escola = ? AND status = ?", new String[]{id_aluno.toString(), DataBaseKariti_2.ID_ESCOLA.toString(), status.toString()});
            if (cursor != null && cursor.moveToFirst()){
    ...
    public String pegaNomeAluno(Integer id_aluno) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeAluno FROM aluno WHERE id_aluno = ? AND id_escola = ?", new String[]{id_aluno.toString(), DataBaseKariti_2.ID_ESCOLA.toString()});
            if (cursor != null && cursor.moveToFirst()){
                nomeAluno = cursor.getString(0);
            }
        }catch (Exception e){
    ...
    public Integer pegarIdAluno(String nomeAluno) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT id_aluno FROM aluno WHERE nomeAluno = ? AND id_escola = ?", new String[]{nomeAluno, DataBaseKariti_2.ID_ESCOLA.toString()});
            if (cursor != null && cursor.moveToFirst()) {
    ...
    public Integer pegarIdEscola(String nomeEscola) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT id_escola FROM escola WHERE nomeEscola = ? AND id_usuario = ?", new String[]{nomeEscola, DataBaseKariti_2.USER_ID.toString()});
            if (cursor != null && cursor.moveToFirst()) {
    ...
    public Integer[] pegarIdProva(String nomeProva) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT id_prova, id_turma FROM prova WHERE nomeProva = ? AND id_turma IN (SELECT id_turma FROM turma WHERE id_escola = ?)", new String[]{nomeProva, DataBaseKariti_2.ID_ESCOLA.toString()});
            if (cursor != null && cursor.moveToFirst()){
    ...
    public Integer pegarIdTurma(String nomeTurma) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT id_turma FROM turma WHERE nomeTurma = ? AND id_escola = ?", new String[]{nomeTurma, DataBaseKariti_2.ID_ESCOLA.toString()});
            if (cursor != null && cursor.moveToFirst()) {
    ...
    public String pegarEmailAluno(Integer id_aluno) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT email FROM aluno WHERE id_aluno = ? AND status = ? AND id_escola = ?", new String[]{id_aluno.toString(), "1", DataBaseKariti_2.ID_ESCOLA.toString()});
            if (cursor != null && cursor.moveToFirst()){
    ...
    public String pegarNomeEscola() {
        ...
        try {
            base_dados = this.getWritableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeEscola FROM escola WHERE id_escola = ? AND id_usuario = ?", new String[]{DataBaseKariti_2.ID_ESCOLA.toString(), DataBaseKariti_2.USER_ID.toString()});
            if (cursor != null && cursor.moveToFirst()){
    ...
    public String pegarNomeUsuario() {
        ...
        try {
            base_dados = this.getWritableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeUsuario FROM usuario WHERE id_usuario = ?", new String[]{DataBaseKariti_2.USER_ID.toString()});
            if (cursor != null && cursor.moveToFirst()){
                nomeUsuario = cursor.getString(0);
            }
        }catch (Exception e){
    ...
    public Integer pegarQtdAlunosPorStatus(String id_turma, Integer status) {
        ...
        try {
            base_dados  = this.getReadableDatabase();
            cursor = base_dados .rawQuery("SELECT COUNT (DISTINCT id_aluno) FROM aluno WHERE id_aluno IN (SELECT id_aluno FROM alunosTurma WHERE id_turma = ?) AND status = ? AND id_escola = ?", new String[]{id_turma, status.toString(), DataBaseKariti_2.ID_ESCOLA.toString()});
            if (cursor != null && cursor.moveToFirst()) {
    ...
    public List<String> listarNomesAlunos(Integer status) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeAluno FROM aluno WHERE status = ? AND id_escola = ? ORDER BY nomeAluno ASC", new String[]{status.toString(), DataBaseKariti_2.ID_ESCOLA.toString()});
            if (cursor != null && cursor.moveToFirst()) {
                do {
    ...
    public List<String> listarAlunosPorTurma(String id_turma) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeAluno FROM aluno WHERE id_escola = ? AND id_aluno IN (SELECT id_aluno FROM alunosTurma WHERE id_turma = ?) ORDER BY nomeAluno ASC", new String[]{DataBaseKariti_2.ID_ESCOLA.toString(), id_turma});
            if (cursor != null && cursor.moveToFirst()) {
                do {
    ...
    public List<String> listarAlunosTurmaPorStatus(String id_turma, Integer status) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeAluno FROM aluno WHERE id_escola = ? AND status = ? AND id_aluno IN (SELECT id_aluno FROM alunosTurma WHERE id_turma = ?) ORDER BY nomeAluno ASC", new String[]{DataBaseKariti_2.ID_ESCOLA.toString(), status.toString(), id_turma});
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    String aluno = cursor.getString(0);
                    alunos.add(aluno);
    ...
    public List<Integer> listarIdsAlunosPorProvaCorrigida(Integer id_prova){
        ...
        try {
            ...
            cursor = db.rawQuery("SELECT id_aluno FROM aluno WHERE id_aluno IN (SELECT id_aluno FROM resultadoCorrecao where id_prova = ?) AND id_escola = ? ORDER BY nomeAluno", new String[]{id_prova.toString(), DataBaseKariti_2.ID_ESCOLA.toString()});
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    Integer id_aluno = cursor.getInt(0);
    ...
    public List<String> listarNomesTurmas() {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeTurma FROM turma WHERE id_escola = ? ORDER BY id_turma DESC", new String[]{String.valueOf(DataBaseKariti_2.ID_ESCOLA)});
            if (cursor != null && cursor.moveToFirst()) {
                do {
    ...
    public List<String> listarTurmasPorProva() {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeTurma FROM turma WHERE id_escola = ? AND id_turma IN (SELECT id_turma FROM prova) ORDER BY id_turma DESC", new String[]{String.valueOf(DataBaseKariti_2.ID_ESCOLA)});
            if (cursor != null && cursor.moveToFirst()) {
                do{
                    String nomeTurma = cursor.getString(0);
                    nomesTurma.add(nomeTurma);
    ...
    public List<String> listarEscolas(Integer status) {
        ...
        try {
            base_dados = this.getReadableDatabase();
            cursor = base_dados.rawQuery("SELECT nomeEscola FROM escola WHERE id_usuario = ? AND status = ?  ORDER BY nomeEscola ASC", new String[]{DataBaseKariti_2.USER_ID.toString(), status.toString()});
            if (cursor != null && cursor.moveToFirst()) {
                do {
    ...
    public List<Answer_key> listarDadosGabarito(Integer id_prova) {
        List<Answer_key> answerkey = new ArrayList<>();
        SQLiteDatabase base_dados = null;
        Cursor cursor = null;
        try {
            base_dados = this.getReadableDatabase();
            ...
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    ...
                    Answer_key g = new Answer_key(questao,resposta, nota);
                    answerkey.add(g);
                } while (cursor.moveToNext());
            }
        } catch (Exception e){
